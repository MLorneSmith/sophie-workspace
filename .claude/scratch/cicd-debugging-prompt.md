...
2. Workflows when trying to deploy from dev to staging are failing
3. We have some Snyk related PRs that need to be dealt with


I want you to:
1. Conduct an audit of the status of the cicd pipeline development
2. Debug the pipeline
3. Check for snyk related branches. delete snyk related branches that are not needed
