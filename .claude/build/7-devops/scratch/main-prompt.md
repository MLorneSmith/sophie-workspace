...
# My Questions
1. In the .claude/build/1-process/1-idea-to-prd/idea-to-prd-prompt.xml prompt, how does does the Product Owner get input from the user? the prompt references teh following context files:
      <context_files>
        - business-context.md
        - user-research.md
...
But these do not exist. We need to create a discussion with the user to get the initial feature idea. We then may need to do additional research to create some of these files. business-context.md is probably not necessary
2. What are your thoughts on how we can clarify and improve the intake of idea information from the user?
