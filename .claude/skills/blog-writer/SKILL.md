---
name: blog-writer
description: Create category-aware, AEO-optimized blog posts for SlideHeroes. Use when writing technology deep-dives, company announcements, or product launches.
allowed-tools: Read, Grep, Glob, Write, Edit
---

# Blog Writer

Create clear, accurate blog posts that help users understand SlideHeroes capabilities and presentation industry trends.
