---
description: Classify a GitHub issue as bug, chore, or feature to route to the appropriate planning command. Use when user provides a GitHub issue that needs categorization
model: haiku
