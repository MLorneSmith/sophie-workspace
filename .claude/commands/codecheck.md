...
- .ai/ai_scripts/codecheck-direct.sh (main execution script)
</inputs>
...
bash .ai/ai_scripts/codecheck-direct.sh
```
...
|-------|-------------------|----------------|
| Script exists | `.ai/ai_scripts/codecheck-direct.sh` found | Report missing script error |
...
- .ai/ai_scripts/codecheck-direct.sh present
