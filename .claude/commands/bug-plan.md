...
### 4. Read Relevant Context Documentation
...
slashCommand /conditional_docs bug-plan "[brief summary of bug or domain area]"
```
The system will intelligently select documentation based on keywords in the bug (auth, database, performance, docker, etc.) and return them as paths in markdown

### 5. **Read each of these suggested documents that are generated by /conditional_docs**
Read each of the suggested documents
