...
- [[web-vitals-testing]]: Detailed Core Web Vitals testing patterns
- [[load-testing-patterns]]: k6 and Artillery load testing
- [[performance-monitoring]]: APM and RUM setup guides
