    ...
    create or replace table `slideheroes-data-platform`.`core`.`dim_companies`
  ...
  select
    ...
    employee_range
  from `slideheroes-data-platform`.`core`.`stg_attio_companies`
),
...
apollo as (
  ...
  from `slideheroes-data-platform`.`core`.`stg_apollo_organizations`
),
