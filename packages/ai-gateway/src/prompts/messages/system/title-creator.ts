/**
 * System message for the title creator role
 * Defines the AI's role, output format, and guidelines for creating presentation titles
 */
...
export default titleCreatorSystem;
