...
Primary Goal: {{presentation_goal}}
Target Audience: {{target_audience}}
Desired Tone: {{tone}}

Generate 3-5 unique title suggestions that:
...
For each suggestion, explain why it would be effective for this specific presentation context.`;
