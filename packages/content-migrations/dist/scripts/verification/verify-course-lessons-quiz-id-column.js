...
async function verifyCourseLessonsQuizIdColumn() {
    ...
    try {
        ...
        try {
            ...
            console.log('Checking if quiz_id_id column exists in course_lessons table...');
      ...
      `);
            ...
            if (mismatchCount === 0) {
                ...
                console.log(`❌ Found ${mismatchCount} lessons where quiz_id_id does not match quiz_id`);
                return false;
            }
            // 3. Check if relationship entries exist in course_lessons_rels
            console.log('Checking if relationship entries exist in course_lessons_rels...');
      ...
      `);
            ...
            if (missingCount === 0) {
                ...
                console.log(`⚠️ Found ${missingCount} lessons missing relationship entries in course_lessons_rels`);
                console.log('Note: This may be expected if no relationships have been created yet');
            }
