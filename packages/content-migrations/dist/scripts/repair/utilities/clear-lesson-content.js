...
export async function clearLessonContent() {
    try {
        ...
        console.log(`Found ${beforeCount} lessons with non-NULL content before clearing`);
        if (beforeCount > 0) {
       ...
       COMMIT;`);
        ...
        console.log(`Found ${afterCount} lessons with non-NULL content after clearing`);
