...
const YAML_PATH = path.join(BASE_DIR, 'src/data/definitions/lessons_structured_content.yaml');
...
function generateLessonEnhancementsSQL() {
    ...
    if (!fs.existsSync(YAML_PATH)) {
        ...
        console.info('Please run the analyze-lesson-content.ts script first to generate the YAML file.');
        process.exit(1);
    }
    // Read the YAML file
