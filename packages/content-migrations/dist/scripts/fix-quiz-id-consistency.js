...
exports.generateFixedQuizzesSql = generateFixedQuizzesSql;
exports.writeFixedQuizzesSql = writeFixedQuizzesSql;
exports.fixQuizIdConsistency = fixQuizIdConsistency;
/**
 ...
 */
function generateFixedQuizzesSql() {
 ...
 */
function writeFixedQuizzesSql(outputPath) {
    const sql = generateFixedQuizzesSql();
    fs_1.default.writeFileSync(outputPath, sql);
    console.log(`Fixed quiz IDs written to ${outputPath}`);
}
// Main function
function fixQuizIdConsistency() {
    ...
    const outputDir = path_1.default.join(projectRoot, 'apps/payload/src/seed/sql');
    const outputPath = path_1.default.join(outputDir, '03-quizzes.sql');
