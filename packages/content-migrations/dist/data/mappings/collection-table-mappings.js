...
export const COLLECTION_TABLE_NAMES = {
 ...
 */
export function getTableNameForCollection(collectionType) {
 ...
 */
export const COLLECTION_DOWNLOAD_MAPPINGS = {
 ...
 */
export function getDownloadsForCollection(collectionId, collectionType) {
