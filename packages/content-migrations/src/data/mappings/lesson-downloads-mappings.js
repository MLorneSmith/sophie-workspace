 ...
 *
 * This file re-exports items from the consolidated download-mappings.js file
 * to maintain backward compatibility with existing code.
 *
 * For new code, please import directly from './download-mappings.js'
 */
import {
  LESSON_DOWNLOADS_MAPPING,
  getDownloadIdsForLesson,
} from './download-mappings.js';
