  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.log(
          `Updated ${updateQuizFieldResult.rowCount} field names in quiz_questions_rels`,
        );
        ...
        console.log(
          `Created ${createSurveyRelsResult.rowCount} bidirectional relationships for surveys`,
        );
        ...
        console.log(
          `Created ${createQuizRelsResult.rowCount} bidirectional relationships for quizzes`,
        );
