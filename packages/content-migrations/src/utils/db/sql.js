 ...
 * @param {Array} conditionValues - Values for the condition
 * @returns {object} SQL query object
 */
 ...
 *
 * @param {string|Array<string>} columns - Columns to select
 * @param {string} table - Table name
 * @param {string} condition - WHERE condition (optional)
 * @param {Array} values - Values for the condition (optional)
 * @returns {object} SQL query object
 */
