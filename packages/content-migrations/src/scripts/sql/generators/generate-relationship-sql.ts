 ...
 */
export function generateRelationshipTablesSql(): string {
 ...
 */
export function generateRelationshipEntrySql(
  parentId: string,
  field: string,
  value: string,
  tableName: string,
  specificIdField?: string, // Optional id field name for additional columns (e.g., downloads_id)
): string {
