...
async function verifyMediaColumns() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        'Checking if media_id column exists in course_lessons table...',
      );
      ...
      if (lessonsColumnExistsResult.rows[0].exists) {
        ...
        console.log(
          '❌ Column media_id does not exist in course_lessons table',
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id column exists in course_quizzes table...',
      );
      ...
      if (quizzesColumnExistsResult.rows[0].exists) {
        ...
        console.log(
          '❌ Column media_id does not exist in course_quizzes table',
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id column exists in quiz_questions table...',
      );
      ...
      if (questionsColumnExistsResult.rows[0].exists) {
        ...
        console.log(
          '❌ Column media_id does not exist in quiz_questions table',
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id column exists in payload_locked_documents table...',
      );
      ...
      if (lockedDocumentsColumnExistsResult.rows[0].exists) {
        console.log(
          '✅ Column media_id exists in payload_locked_documents table',
        );
      } else {
        console.log(
          '❌ Column media_id does not exist in payload_locked_documents table',
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id column exists in payload_locked_documents_rels table...',
      );
      ...
      if (lockedDocumentsRelsColumnExistsResult.rows[0].exists) {
        console.log(
          '✅ Column media_id exists in payload_locked_documents_rels table',
        );
      } else {
        console.log(
          '❌ Column media_id does not exist in payload_locked_documents_rels table',
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id columns have the correct data type and constraints...',
      );
      ...
      if (columnsInfoResult.rows.length === 5) {
        ...
        for (const row of columnsInfoResult.rows) {
          if (row.data_type === 'uuid') {
            console.log(
              `✅ Column media_id in ${row.table_name} has the correct data type (uuid)`,
            );
          } else {
            console.log(
              `❌ Column media_id in ${row.table_name} has incorrect data type: ${row.data_type}, expected: uuid`,
            );
            return false;
          }
        }
        ...
        console.log(
          `❌ Expected 5 media_id columns, found ${columnsInfoResult.rows.length}`,
        );
        return false;
      }
      ...
      console.log(
        'Checking if media_id columns have foreign key constraints to the media table...',
      );
      ...
      if (fkConstraintsResult.rows.length === 5) {
        console.log(
          '✅ All five media_id columns have foreign key constraints to the media table',
        );
      } else {
        console.log(
          `❌ Expected 5 foreign key constraints, found ${fkConstraintsResult.rows.length}`,
        );
        for (const table of [
          'course_lessons',
          'course_quizzes',
          ...
          const hasConstraint = fkConstraintsResult.rows.some(
            (row) => row.table_name === table,
          );
          if (!hasConstraint) {
            console.log(
              `❌ Missing foreign key constraint for ${table}.media_id`,
            );
          }
        }
        return false;
