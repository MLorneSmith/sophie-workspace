...
async function verifyDatabaseSchema() {
  ...
  try {
    ...
    try {
      ...
      const relsTablesResult = await client.query(
        "SELECT table_name FROM information_schema.tables WHERE table_schema = 'payload' AND table_name LIKE '%_rels' ORDER BY table_name",
      );
