...
async function main() {
  ...
  try {
    ...
    `);
    console.log(
      `Removed ${removeDuplicateFromLessons.rowCount} duplicate lesson-quiz relationships`,
    );
    ...
    `);
    console.log(
      `Removed ${removeDuplicateFromQuizzes.rowCount} duplicate quiz-lesson relationships`,
    );
    ...
    console.log(
      `Found ${lessonsWithQuizzes.rowCount} lessons with quiz_id set`,
    );
    ...
    console.log(
      `Found ${lessonQuizRels.rowCount} existing lesson-to-quiz relationships`,
    );
    ...
    console.log(
      `Found ${quizLessonRels.rowCount} existing quiz-to-lesson relationships`,
    );
    ...
    console.log(
      `Created ${createLessonToQuizResult.rowCount} missing lesson-to-quiz relationships`,
    );
    ...
    console.log(
      `Created ${createQuizToLessonResult.rowCount} missing quiz-to-lesson relationships`,
    );

    // Add the course_lessons_id to course_quizzes_rels if needed
    console.log(
      'Fixing relationship ID fields in course_quizzes_rels table...',
    );
    ...
    if (!columnExists.rows[0].exists) {
      console.log(
        'Adding course_lessons_id column to course_quizzes_rels table...',
      );
      await pool.query(`
    ...
    console.log(
      `Updated course_lessons_id for ${updateCourseQuizzesRels.rowCount} lesson relationships`,
    );

    // Add the course_quizzes_id to course_lessons_rels if needed
    console.log(
      'Fixing relationship ID fields in course_lessons_rels table...',
    );
    ...
    if (!quizColumnExists.rows[0].exists) {
      console.log(
        'Adding course_quizzes_id column to course_lessons_rels table...',
      );
      await pool.query(`
    ...
    console.log(
      `Updated course_quizzes_id for ${updateCourseLessonsRels.rowCount} quiz relationships`,
    );
    ...
    `);
    const lessonsWithQuizCount = parseInt(
      verifyLessons.rows[0].lessons_with_quiz,
    );
    ...
    `);
    const quizQuestionsIdCount = parseInt(
      verifyQuizQuestionsId.rows[0].with_id,
    );
    ...
    console.log(
      `Verification: ${lessonsWithQuizCount} lessons with quiz ${lessonRelsCount} lesson relationships ${quizRelsCount} quiz relationships`,
    );
    console.log(
      `Quiz questions relationships: ${quizQuestionsIdCount} total ${quizQuestionsIdCount} with quiz_questions_id set`,
    );
    console.log(
      `Lesson relationships in quizzes: ${lessonsIdCount} total ${lessonsIdCount} with course_lessons_id set`,
    );

    if (
      lessonsWithQuizCount !== lessonRelsCount ||
