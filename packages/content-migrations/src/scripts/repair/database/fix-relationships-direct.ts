  ...
  try {
    ...
    try {
      ...
      try {
        ...
        `);
        console.log(
          `Updated ${updateQuizIdResult.rowCount} quiz_id_id values to match quiz_id`,
        );

        // 2. Create bidirectional relationships for surveys and survey_questions
        console.log(
          'Creating bidirectional relationships for surveys and survey_questions...',
        );
        ...
        console.log(
          `Created ${createdSurveyRels} bidirectional relationships in surveys_rels table`,
        );
        ...
        console.log(
          `Created ${createdQuizQuestionRels} relationships in quiz_questions_rels table`,
        );

        // 4. Create bidirectional relationships in course_quizzes_rels table
        console.log(
          'Creating bidirectional relationships in course_quizzes_rels table...',
        );
        ...
        console.log(
          `Created ${createdQuizRels} bidirectional relationships in course_quizzes_rels table`,
        );
        ...
        const quizQuestionsCount = parseInt(
          quizQuestionsCountResult.rows[0].count,
        );
        const bidirectionalQuizRelsCount = parseInt(
          bidirectionalQuizRelsCountResult.rows[0].count,
        );

        console.log(
          `Verification: ${quizQuestionsCount} quiz questions ${bidirectionalQuizRelsCount} bidirectional relationships`,
        );
        ...
        if (quizQuestionsCount === bidirectionalQuizRelsCount) {
          ...
          console.log(
            '⚠️ Some quiz relationships are not properly bidirectional',
          );
        }
