/**
 * Enhanced UUID Table Detection - Fixed Version
 * Focuses on finding relationship tables and adding compatibility for various table patterns
 */
import pg from 'pg';
...
export async function detectUuidTables(
  ...
  try {
    ...
    if (tablesResult.rows.length === 0) {
      console.warn(
        '⚠️ No relationship or UUID tables found in payload schema! This is unusual.',
      );
