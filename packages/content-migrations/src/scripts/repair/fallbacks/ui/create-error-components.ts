...
`;
    ...
    const relationshipFallbackPath = path.join(
      componentsDir,
      'RelationshipFallback.tsx',
    );
...
`;
    ...
    logger.info(
      `Created relationship fallback component at ${relationshipFallbackPath}`,
      { module: 'fallbacks', component: 'admin-ui' },
    );
