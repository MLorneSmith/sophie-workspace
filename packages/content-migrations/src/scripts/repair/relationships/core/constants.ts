/**
 * Configuration constants for relationship repair system
 */
import { RelationshipFixConfig } from './types.js';

/**
 * Default configurations for known important relationships
 */
export const COMMON_RELATIONSHIP_CONFIGS: RelationshipFixConfig[] = [
  {
 ...
 */
export const UUID_TABLE_PATTERN =
 ...
 */
export const RELATIONSHIP_MAP_FILE_PATH =
  'src/data/mappings/relationship-map.json';
