 ...
 */
export async function createQuizQuestionViews(): Promise<boolean> {
 ...
 */
export async function createInvalidRelationshipsView(): Promise<boolean> {
 ...
 */
export async function createAllRelationshipViews(): Promise<boolean> {
  try {
