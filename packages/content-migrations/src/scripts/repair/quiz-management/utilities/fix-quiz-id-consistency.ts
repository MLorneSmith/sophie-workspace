 ...
 */
export function generateFixedQuizzesSql(): string {
 ...
 */
export function writeFixedQuizzesSql(outputPath: string): void {
...
// Main function
export function fixQuizIdConsistency(): void {
  ...
  const projectRoot = path.resolve(
    ...
    '../../../../..', // Go from /packages/content-migrations/src/scripts/fix-quiz-id-consistency.ts to project root
  );
