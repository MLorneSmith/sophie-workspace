    ...
    if (!response.ok) {
        ...
        try {
            ...
            try {
                ...
                // Not valid JSON
                /* TODO: Async logger needed */ logger.error(`[${requestId}] Payload API error (non-JSON):`, response.status, response.statusText, errorText);
                errorMessage =
            ...
            /* TODO: Async logger needed */ logger.error(`[${requestId}] Payload API error (unreadable):`, response.status, response.statusText);
