 ...
 * @deprecated Use Supabase directly instead
 */
export declare function createSurveyResponse(_data: any): Promise<{
    id: null;
}>;
/**
 * @deprecated Use Supabase directly instead
 */
export declare function updateSurveyResponse(id: string, _data: any): Promise<{
    id: string;
}>;
/**
 * @deprecated Use Supabase directly instead
 */
export declare function completeSurvey(id: string, _data: any): Promise<{
    id: string;
}>;
