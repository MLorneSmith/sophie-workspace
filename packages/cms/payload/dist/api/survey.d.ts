 ...
 */
export declare function getSurvey(
	slug: string,
	supabaseClient?: any,
): Promise<any>;
/**
 ...
 */
export declare function getSurveyQuestions(
	surveyId: string,
	supabaseClient?: any,
): Promise<any>;
/**
 ...
 */
export declare function getUserSurveyResponse(
	userId: string,
	surveyId: string,
): Promise<{
	docs: never[];
 ...
 * @deprecated Use Supabase directly instead
 */
export declare function updateSurveyResponse(
	id: string,
	data: any,
): Promise<{
	id: string;
 ...
 * @deprecated Use Supabase directly instead
 */
export declare function completeSurvey(
	id: string,
	data: any,
): Promise<{
	id: string;
