 ...
 */
export async function getCourseBySlug(slug, options = {}) {
 ...
 */
export async function getCourseLessons(courseId, options = {}) {
    return callPayloadAPI(`course_lessons?where[course][equals]=${courseId}&sort=lessonNumber&depth=0`);
}
/**
 ...
 */
export async function getLessonBySlug(slug, options = {}) {
