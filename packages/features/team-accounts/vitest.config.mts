...
/**
 * Vitest configuration for team-accounts package
 * Extends base configuration for team account testing
 */
export default defineProject({
	...
	test: {
		...
		// Include TS files for team-accounts services and policies
