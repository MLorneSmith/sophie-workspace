...
export function AppEventsProvider({ children }) {
	...
	const emit = useCallback(
		(event) => {
			...
			const eventListeners =
				(_a = listeners.current[event.type]) !== null && _a !== void 0
					? _a
					: [];
	...
	const on = useCallback((eventType, callback) => {
		var _a;
		listeners.current = Object.assign(Object.assign({}, listeners.current), {
			[eventType]: [
				...((_a = listeners.current[eventType]) !== null && _a !== void 0
					? _a
					: []),
				callback,
			],
	...
	const off = useCallback((eventType, callback) => {
		var _a;
		listeners.current = Object.assign(Object.assign({}, listeners.current), {
			[eventType]: ((_a = listeners.current[eventType]) !== null &&
			_a !== void 0
				? _a
				: []
