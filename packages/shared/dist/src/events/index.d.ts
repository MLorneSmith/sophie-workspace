...
export declare function AppEventsProvider<T extends ConsumerProvidedEventTypes = ConsumerProvidedEventTypes, K extends AppEventType<T> = AppEventType<T>>({ children }: React.PropsWithChildren): import("react").JSX.Element;
