  ...
  return (
    <div className="group/card w-full max-w-xs">
      ...
      >
        ...
        <div className="absolute left-0 top-0 h-full w-full bg-black/0 transition duration-300 group-hover/card:bg-black/30"></div>

        <div className="z-10 flex flex-col space-y-3">
          <div className="flex flex-row items-center space-x-3">
            {renderIcon()}
            <span className="text-base font-medium" style={{ color: '#24a9e0' }}>
              {blogType}
            </span>
