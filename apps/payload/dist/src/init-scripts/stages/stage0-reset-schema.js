import pkg from 'pg';
const { Client } = pkg;
export async function runStage0_ResetSchema(logger, cliArgs) {
    ...
    try {
        ...
        if (pgClient._connected) { // Check if client was connected
...
//# sourceMappingURL=stage0-reset-schema.js.map