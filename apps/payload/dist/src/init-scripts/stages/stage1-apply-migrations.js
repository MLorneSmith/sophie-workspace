...
export async function runStage1_ApplyMigrations(logger, cliArgs) {
    ...
    try {
        const { stdout, stderr, exitCode } = await execa('pnpm', ['--filter', 'payload', 'payload', 'migrate', '--yes'], // '--yes' to auto-confirm prompts
        {
...
//# sourceMappingURL=stage1-apply-migrations.js.map