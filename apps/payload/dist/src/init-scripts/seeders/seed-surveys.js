...
export async function seedSurveys(payload, logger, cliArgs) {
    ...
    for (const surveyData of ssotSurveys) {
        ...
        try {
            ...
            const descriptionContent = surveyData.description ? await markdocToLexical(surveyData.description) : null;
            const introductionContent = surveyData.introduction ? await markdocToLexical(surveyData.introduction) : null;
...
//# sourceMappingURL=seed-surveys.js.map