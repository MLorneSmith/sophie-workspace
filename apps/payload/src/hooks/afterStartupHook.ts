...
export const afterStartupHook = async (payload: Payload): Promise<void> => {
  ...
  console.log('This hook runs AFTER Payload has regenerated the importMap')
  console.log('========================================')
  ...
  if (fs.existsSync(importMapPath)) {
    ...
    const mappings = [
      ...
      // Add specific mappings for the Field component that Payload is looking for
      // These are the exact paths Payload is trying to resolve according to the error
      `  "./Field#default": TestBlockField_e70f5e05f09f93e00b997edb1ef0c864`,
      `  "./Field": TestBlockField_e70f5e05f09f93e00b997edb1ef0c864`,
      `  "Field#default": TestBlockField_e70f5e05f09f93e00b997edb1ef0c864`,
      `  "Field": TestBlockField_e70f5e05f09f93e00b997edb1ef0c864`,

      // Add mappings for _components field
    ...
    console.log('ImportMap file completely rebuilt from scratch by afterStartupHook')
