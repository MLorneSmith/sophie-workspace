...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "payload"."enum_quiz_questions_status" AS ENUM('draft', 'published');
  CREATE TYPE "payload"."enum__quiz_questions_v_version_type" AS ENUM('multiple_choice');
  CREATE TYPE "payload"."enum__quiz_questions_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE IF NOT EXISTS "payload"."quiz_questions" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "payload"."enum_quiz_questions_status" DEFAULT 'draft'
  );
  
  CREATE TABLE IF NOT EXISTS "payload"."_quiz_questions_v_version_options" (
  	"_order" integer NOT NULL,
  	"_parent_id" uuid NOT NULL,
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"text" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "payload"."_quiz_questions_v" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"parent_id" uuid,
  	"version_question" varchar,
  	"version_type" "payload"."enum__quiz_questions_v_version_type" DEFAULT 'multiple_choice',
  	"version_explanation" varchar,
  	"version_order" numeric DEFAULT 0,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "payload"."enum__quiz_questions_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE IF NOT EXISTS "payload"."_surveys_v" (
  	...
  	"version_slug" varchar,
  	"version_description" varchar,
  	"version_start_message" jsonb,
  	"version_end_message" jsonb,
  	"version_show_progress_bar" boolean DEFAULT true,
  	"version_summary_content" jsonb,
  ...
  DO $$ BEGIN
   ALTER TABLE "payload"."_quiz_questions_v_version_options" ADD CONSTRAINT "_quiz_questions_v_version_options_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."_quiz_questions_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload"."_quiz_questions_v" ADD CONSTRAINT "_quiz_questions_v_parent_id_quiz_questions_id_fk" FOREIGN KEY ("parent_id") REFERENCES "payload"."quiz_questions"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload"."posts" ADD CONSTRAINT "posts_image_id_id_downloads_id_fk" FOREIGN KEY ("image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload"."_posts_v" ADD CONSTRAINT "_posts_v_version_image_id_id_downloads_id_fk" FOREIGN KEY ("version_image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "quiz_questions__status_idx" ON "payload"."quiz_questions" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_version_options_order_idx" ON "payload"."_quiz_questions_v_version_options" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_version_options_parent_id_idx" ON "payload"."_quiz_questions_v_version_options" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_parent_idx" ON "payload"."_quiz_questions_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_version_version_updated_at_idx" ON "payload"."_quiz_questions_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_version_version_created_at_idx" ON "payload"."_quiz_questions_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_version_version__status_idx" ON "payload"."_quiz_questions_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_created_at_idx" ON "payload"."_quiz_questions_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_updated_at_idx" ON "payload"."_quiz_questions_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_quiz_questions_v_latest_idx" ON "payload"."_quiz_questions_v" USING btree ("latest");
  ...
  CREATE INDEX IF NOT EXISTS "surveys_rels_survey_questions_id_idx" ON "payload"."surveys_rels" USING btree ("survey_questions_id");
  ...
  CREATE INDEX IF NOT EXISTS "_surveys_v_rels_survey_questions_id_idx" ON "payload"."_surveys_v_rels" USING btree ("survey_questions_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "payload"."_quiz_questions_v_version_options" CASCADE;
  DROP TABLE "payload"."_quiz_questions_v" CASCADE;
  ...
  DROP TYPE "payload"."enum_quiz_questions_status";
  DROP TYPE "payload"."enum__quiz_questions_v_version_type";
  DROP TYPE "payload"."enum__quiz_questions_v_version_status";
