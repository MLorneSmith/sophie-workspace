 ...
 */
export function parseMarkdocFile(filePath: string) {
  try {
    const fileContent = fs.readFileSync(filePath, 'utf8')
 ...
 */
export function readFilesWithExtension(dirPath: string, extension: string) {
  try {
 ...
 */
export function convertMarkdocToLexical(content: string) {
 ...
 */
export function extractBunnyVideoId(content: string) {
