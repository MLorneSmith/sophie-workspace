/**
 * Unit tests for CourseProgressBar component
 * Tests progress calculation logic and rendering behavior
 */
  ...
  describe('Business Logic Verification', () => {
    it('should always use calculated percentage, never the passed percentage prop', () => {
      ...
      const testCases = [
        ...
        { percentage: 100, totalLessons: 8, completedLessons: 3, expected: '38' },
        { percentage: 999, totalLessons: 2, completedLessons: 1, expected: '50' },
        { percentage: -50, totalLessons: 10, completedLessons: 9, expected: '90' },
      ];

      testCases.forEach(({ percentage, totalLessons, completedLessons, expected }, index) => {
        // Act
    ...
    it('should correctly calculate percentages for various fraction scenarios', () => {
      ...
      testCases.forEach(({ totalLessons, completedLessons, expected }, index) => {
        // Act
        const { unmount } = render(
          <CourseProgressBar 
            percentage={0} 
