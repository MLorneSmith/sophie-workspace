...
describe('Task Schema Validation', () => {
	...
	describe('CreateTaskSchema', () => {
		...
		it('should validate optional description field', () => {
			...
			expect(() => CreateTaskSchema.parse(taskWithoutDescription)).not.toThrow();
			expect(CreateTaskSchema.parse(taskWithoutDescription).description).toBeUndefined();
		});
	});
	...
	describe('File Validation', () => {
		...
		it('should reject file over size limit', () => {
			...
			expect(() => CreateTaskSchema.parse(task)).toThrow('Image must be less than 1MB');
		});
	...
	describe('UpdateTaskSchema', () => {
		...
		it('should inherit all CreateTaskSchema validations', () => {
			...
			expect(() => UpdateTaskSchema.parse(updateData)).toThrow('Title is required');
		});
	});
