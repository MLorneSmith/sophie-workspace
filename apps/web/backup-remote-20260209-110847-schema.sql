...
CREATE TYPE "payload"."enum__private_posts_v_version_status" AS ENUM (
    'draft',
    'published'
);


ALTER TYPE "payload"."enum__private_posts_v_version_status" OWNER TO "postgres";
...
CREATE TYPE "payload"."enum_private_posts_status" AS ENUM (
    'draft',
    'published'
);


ALTER TYPE "payload"."enum_private_posts_status" OWNER TO "postgres";


CREATE TYPE "payload"."enum_quiz_questions_questiontype" AS ENUM (
    'single-answer',
    'multi-answer'
);


ALTER TYPE "payload"."enum_quiz_questions_questiontype" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "payload"."_course_lessons_v" (
    ...
    "version_todo" "jsonb",
    "version_todo_watch_content" "jsonb",
    "version_todo_read_content" "jsonb",
    "version_todo_course_project" "jsonb",
...
CREATE TABLE IF NOT EXISTS "payload"."_private_posts_v" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "parent_id" "uuid",
    "version_title" character varying,
    "version_slug" character varying,
    ...
    "version_status" "payload"."enum__private_posts_v_version_status" DEFAULT 'draft'::"payload"."enum__private_posts_v_version_status",
    "version_updated_at" timestamp(3) with time zone,
    "version_created_at" timestamp(3) with time zone,
    "version__status" "payload"."enum__private_posts_v_version_status" DEFAULT 'draft'::"payload"."enum__private_posts_v_version_status",
    "created_at" timestamp(3) with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp(3) with time zone DEFAULT "now"() NOT NULL,
    "latest" boolean
);
...
ALTER TABLE "payload"."_private_posts_v" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "payload"."_private_posts_v_rels" (
    "id" integer NOT NULL,
    "order" integer,
    "parent_id" "uuid" NOT NULL,
    "path" character varying NOT NULL,
...
ALTER TABLE "payload"."_private_posts_v_rels" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "payload"."_private_posts_v_rels_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "payload"."_private_posts_v_rels_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "payload"."_private_posts_v_rels_id_seq" OWNED BY "payload"."_private_posts_v_rels"."id";



CREATE TABLE IF NOT EXISTS "payload"."_private_posts_v_version_categories" (
    "_order" integer NOT NULL,
    "_parent_id" "uuid" NOT NULL,
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "category" character varying,
...
ALTER TABLE "payload"."_private_posts_v_version_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "payload"."_private_posts_v_version_tags" (
    "_order" integer NOT NULL,
    "_parent_id" "uuid" NOT NULL,
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "tag" character varying,
...
ALTER TABLE "payload"."_private_posts_v_version_tags" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "payload"."course_lessons" (
    ...
    "todo" "jsonb",
    "todo_watch_content" "jsonb",
    "todo_read_content" "jsonb",
    "todo_course_project" "jsonb",
...
CREATE TABLE IF NOT EXISTS "payload"."private_posts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "title" character varying,
    "slug" character varying,
    "description" character varying,
    ...
    "status" "payload"."enum_private_posts_status" DEFAULT 'draft'::"payload"."enum_private_posts_status",
    "updated_at" timestamp(3) with time zone DEFAULT "now"() NOT NULL,
    "created_at" timestamp(3) with time zone DEFAULT "now"() NOT NULL,
    "_status" "payload"."enum_private_posts_status" DEFAULT 'draft'::"payload"."enum_private_posts_status"
);


ALTER TABLE "payload"."private_posts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "payload"."private_posts_categories" (
    "_order" integer NOT NULL,
    "_parent_id" "uuid" NOT NULL,
    "id" character varying NOT NULL,
    "category" character varying
...
ALTER TABLE "payload"."private_posts_categories" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "payload"."private_posts_rels" (
    "id" integer NOT NULL,
    "order" integer,
    "parent_id" "uuid" NOT NULL,
    "path" character varying NOT NULL,
...
ALTER TABLE "payload"."private_posts_rels" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "payload"."private_posts_rels_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "payload"."private_posts_rels_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "payload"."private_posts_rels_id_seq" OWNED BY "payload"."private_posts_rels"."id";



CREATE TABLE IF NOT EXISTS "payload"."private_posts_tags" (
    "_order" integer NOT NULL,
    "_parent_id" "uuid" NOT NULL,
    "id" character varying NOT NULL,
    "tag" character varying
...
ALTER TABLE "payload"."private_posts_tags" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "payload"."quiz_questions" (
    ...
    "questiontype" "payload"."enum_quiz_questions_questiontype" DEFAULT 'single-answer'::"payload"."enum_quiz_questions_questiontype",
...
CREATE OR REPLACE VIEW "public"."timezone_performance_monitor" WITH ("security_invoker"='true') AS
...
COMMENT ON VIEW "public"."timezone_performance_monitor" IS 'Monitor timezone cache status. Note: pg_stat_statements performance metrics not available in managed Supabase. Now uses security_invoker to inherit RLS policies.';
...
ALTER TABLE ONLY "payload"."_private_posts_v_rels" ALTER COLUMN "id" SET DEFAULT "nextval"('"payload"."_private_posts_v_rels_id_seq"'::"regclass");
...
ALTER TABLE ONLY "payload"."private_posts_rels" ALTER COLUMN "id" SET DEFAULT "nextval"('"payload"."private_posts_rels_id_seq"'::"regclass");
...
ALTER TABLE ONLY "payload"."_private_posts_v"
    ADD CONSTRAINT "_private_posts_v_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."_private_posts_v_rels"
    ADD CONSTRAINT "_private_posts_v_rels_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."_private_posts_v_version_categories"
    ADD CONSTRAINT "_private_posts_v_version_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."_private_posts_v_version_tags"
    ADD CONSTRAINT "_private_posts_v_version_tags_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "payload"."private_posts_categories"
    ADD CONSTRAINT "private_posts_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."private_posts"
    ADD CONSTRAINT "private_posts_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."private_posts_rels"
    ADD CONSTRAINT "private_posts_rels_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "payload"."private_posts_tags"
    ADD CONSTRAINT "private_posts_tags_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "payload"."_private_posts_v"
    ADD CONSTRAINT "_private_posts_v_parent_id_private_posts_id_fk" FOREIGN KEY ("parent_id") REFERENCES "payload"."private_posts"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "payload"."_private_posts_v_rels"
    ADD CONSTRAINT "_private_posts_v_rels_downloads_fk" FOREIGN KEY ("downloads_id") REFERENCES "payload"."downloads"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."_private_posts_v_rels"
    ADD CONSTRAINT "_private_posts_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "payload"."_private_posts_v"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."_private_posts_v_version_categories"
    ADD CONSTRAINT "_private_posts_v_version_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."_private_posts_v"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."_private_posts_v"
    ADD CONSTRAINT "_private_posts_v_version_featured_image_id_id_downloads_id_fk" FOREIGN KEY ("version_featured_image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "payload"."_private_posts_v"
    ADD CONSTRAINT "_private_posts_v_version_image_id_id_downloads_id_fk" FOREIGN KEY ("version_image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "payload"."_private_posts_v_version_tags"
    ADD CONSTRAINT "_private_posts_v_version_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."_private_posts_v"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "payload"."payload_locked_documents_rels"
    ADD CONSTRAINT "payload_locked_documents_rels_private_posts_fk" FOREIGN KEY ("private_posts_id") REFERENCES "payload"."private_posts"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "payload"."private_posts_categories"
    ADD CONSTRAINT "private_posts_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."private_posts"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."private_posts"
    ADD CONSTRAINT "private_posts_featured_image_id_id_downloads_id_fk" FOREIGN KEY ("featured_image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "payload"."private_posts"
    ADD CONSTRAINT "private_posts_image_id_id_downloads_id_fk" FOREIGN KEY ("image_id_id") REFERENCES "payload"."downloads"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "payload"."private_posts_rels"
    ADD CONSTRAINT "private_posts_rels_downloads_fk" FOREIGN KEY ("downloads_id") REFERENCES "payload"."downloads"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."private_posts_rels"
    ADD CONSTRAINT "private_posts_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "payload"."private_posts"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "payload"."private_posts_tags"
    ADD CONSTRAINT "private_posts_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "payload"."private_posts"("id") ON DELETE CASCADE;
...
CREATE POLICY "maintenance_log_insert_authenticated" ON "public"."maintenance_log" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "maintenance_log_select_authenticated" ON "public"."maintenance_log" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "maintenance_log_service_role" ON "public"."maintenance_log" TO "service_role" USING (true);
