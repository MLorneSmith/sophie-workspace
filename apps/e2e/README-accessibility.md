...
Our accessibility testing ensures WCAG 2.1 AA compliance across all major application pages
and features. Tests run automatically in the CI/CD pipeline and can be executed locally for
development.
...
TEST_USER_EMAIL=test1@slideheroes.com
