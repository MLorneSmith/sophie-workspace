...
const Schema: Record<string, z.ZodType> = {
	NEXT_PUBLIC_SITE_URL: z
		.string({
			description:
				"This is the URL of your website. It should start with https:// like https://makerkit.dev.",
		})
		.url({
			message:
	...
	NEXT_PUBLIC_PRODUCT_NAME: z
		.string({
			...
			description:
				"This is the name of your product. It should be a short name like MakerKit.",
		})
		.min(1),
	NEXT_PUBLIC_SITE_DESCRIPTION: z.string({
		message: "Site description must be a string",
		description:
			"This is the description of your website. It should be a short sentence or two.",
	}),
	NEXT_PUBLIC_DEFAULT_THEME_MODE: z.enum(["light", "dark", "system"], {
		message: "Default theme mode must be light, dark or system",
		description:
			"This is the default theme mode for your website. It should be light, dark or system.",
	}),
	NEXT_PUBLIC_DEFAULT_LOCALE: z.string({
		message: "Default locale must be a string",
		description:
			"This is the default locale for your website. It should be a two-letter code like en or fr.",
	}),
	CONTACT_EMAIL: z
		.string({
	...
	NEXT_PUBLIC_SUPABASE_ANON_KEY: z.string({
		...
		description:
			"This is the key provided by Supabase. It is a public key used client-side.",
	}),
	SUPABASE_SERVICE_ROLE_KEY: z.string({
		message: "Supabase service role key must be a string",
		description:
			"This is the key provided by Supabase. It is a private key used server-side.",
	}),
	NEXT_PUBLIC_BILLING_PROVIDER: z.enum(["stripe", "lemon-squeezy"], {
		message: "Billing provider must be stripe or lemon-squeezy",
		description:
			"This is the billing provider you want to use. It should be stripe or lemon-squeezy.",
	}),
	NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY: z
		.string({
			message: "Stripe publishable key must be a string",
			description:
				"This is the publishable key from your Stripe dashboard. It should start with pk_",
		})
		.refine(
			(value) => {
	...
	STRIPE_SECRET_KEY: z
		.string({
			...
			description:
				"This is the secret key from your Stripe dashboard. It should start with sk_",
		})
		.refine(
			(value) => {
	...
	STRIPE_WEBHOOK_SECRET: z
		.string({
			...
			description:
				"This is the signing secret you copy after creating a webhook in your Stripe dashboard.",
		})
		.min(1)
		.refine(
			(value) => {
	...
	LEMON_SQUEEZY_SIGNING_SECRET: z
		.string({
			...
			description:
				"This is a shared secret that you must set in your Lemon Squeezy account when you create an API Key",
		})
		.min(1),
	MAILER_PROVIDER: z.enum(["nodemailer", "resend"], {
		message: "Mailer provider must be nodemailer or resend",
		description:
			"This is the mailer provider you want to use for sending emails. nodemailer is a generic SMTP mailer, resend is a service.",
	}),
};
