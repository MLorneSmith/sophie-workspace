...
**Delegate** to context-discovery-expert for pattern loading before clarification:
...
- description: "Discover command creation patterns"
- prompt: "Find relevant context for creating a new command: ${commandName}.
          Purpose: ${commandPurpose}
          Command type: command-new
          Token budget: 4000
          Max results: 3
          Focus on: command creation patterns, design templates, PRIME framework examples"

The expert will:
- Analyze existing similar commands for patterns
- Load general command creation patterns
- Identify relevant documentation
- Return prioritized Read commands

Execute all Read commands returned by the expert to load pattern context.
```

Fallback if context-discovery-expert unavailable:
...
Use Task tool with:
- subagent_type: "context-discovery-expert"
- description: "Discover technical documentation for command implementation"
- prompt: "Find technical context for implementing new command.
          ...
          Token budget: 6000
          Max results: 5
          Focus on: implementation patterns, technical documentation, PRIME compliance"

The expert will:
- Build PRIME-aligned query from clarification answers
- Load specific technical documentation
- Prioritize most relevant implementation patterns
- Return Read commands for all relevant docs

Execute all Read commands returned to load technical context.
```
...
- Context discovery agent fails: **Continue** with essentials only
