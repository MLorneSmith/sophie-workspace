---
# Identity
id: "slideheroes-architecture"
title: "SlideHeroes Architecture Context"
version: "2.1.0"
category: "reference"
...
cross_references:
  - id: "nextjs-patterns"
    type: "pattern"
    description: "Next.js specific patterns"
  - id: "supabase-security"
    type: "related"
    description: "Supabase RLS patterns"
...
- `/packages/next/src/actions/index.ts`: Server action wrapper

**Database**

- `/apps/e2e/supabase/migrations/`: Schema
- `/apps/e2e/supabase/schemas/`: RLS policies
...
**Q1 2025**: R2 migration, error boundaries, OpenTelemetry
**Q2-Q3**: Edge AI services, WebSockets, Redis cache
**Q4+**: Microservices extraction, GraphQL federation

## See Also

- [[nextjs-patterns]]: Implementation patterns
- [[supabase-security]]: RLS deep dive
