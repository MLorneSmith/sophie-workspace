...
- [ci-cd-complete.md](./ci-cd-complete.md): Complete CI/CD architecture
- [database-patterns.md](../development/database-patterns.md): Database migration strategies
- [enhanced-logger.md](./enhanced-logger.md): Logging system
- [newrelic-monitoring.md](./newrelic-monitoring.md): Production monitoring configuration
