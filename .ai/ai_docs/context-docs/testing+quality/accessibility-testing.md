...
- [e2e-testing.md](./e2e-testing.md) - End-to-end testing patterns and Playwright usage
- [fundamentals.md](./fundamentals.md) - Core testing philosophy and best practices
- [ci-cd-complete.md](../infrastructure/ci-cd-complete.md) - CI/CD integration for accessibility tests
