...
cross_references:
  ...
  - id: "react-query-advanced"
    type: "related"
    description: "Advanced patterns including infinite queries and real-time subscriptions"
...
For advanced patterns including infinite queries, dependent queries, real-time subscriptions, and parallel queries, see [react-query-advanced.md](./react-query-advanced.md).
...
Use `Promise.all()` to prefetch multiple queries simultaneously for better performance:
...
**Solution**: Create QueryClient once using `useState(() => new QueryClient())`

### Issue: Race Conditions

**Symptoms**: Inconsistent data after rapid mutations
**Solution**: Cancel in-flight queries before mutations using `queryClient.cancelQueries()`
...
- [react-query-advanced.md](./react-query-advanced.md) - Advanced patterns (infinite queries, real-time, parallel queries)
- [server-actions.md](./server-actions.md) - Server action patterns with enhanceAction
- [database-patterns.md](./database-patterns.md) - Supabase client configuration and patterns
