...
Setup Bitwarden skill


## Description

Build a skill so Sophie can securely access login credentials from Bitwarden when needed for tasks. Revisit when a specific task requires credential access.
