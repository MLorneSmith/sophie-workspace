...
- [Disabling Personal Accounts](https://makerkit.dev/docs/next-supabase-turbo/recipes/team-accounts-only)
- [Onboarding Checkout](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout)
- [Checkout Addons with Stripe Billing](https://makerkit.dev/docs/next-supabase-turbo/recipes/stripe-billing-checkout-addons)
- [Subscription Entitlements](https://makerkit.dev/docs/next-supabase-turbo/recipes/subscription-entitlements)
- [Projects Data Model](https://makerkit.dev/docs/next-supabase-turbo/recipes/projects-data-model)
- [Drizzle](https://makerkit.dev/docs/next-supabase-turbo/recipes/drizzle-supabase)

Developer Tools

Troubleshooting

[Documentation](https://makerkit.dev/docs) [Next.js and Supabase V2](https://makerkit.dev/docs/next-supabase-turbo)
...
01. [Step 0: Adding an Onboarding Table](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-0--adding-an-onboarding-table)
02. [Step 1: Create the Onboarding Page](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-1--create-the-onboarding-page)
03. [Step 2: Create the Onboarding Form Schema](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-2--create-the-onboarding-form-schema)
04. [Step 3: Create the Onboarding Form Component](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-3--create-the-onboarding-form-component)
05. [Step 4: Create the Server Action](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-4--create-the-server-action)
06. [Step 6: Enhancing the Stripe Webhook Handler](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-6--enhancing-the-stripe-webhook-handler)
07. [Step 7: Handling the Onboarding Completion Page](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-7--handling-the-onboarding-completion-page)
08. [What This Means for Your Onboarding Flow](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#what-this-means-for-your-onboarding-flow)
09. [Step 8: Update Your App's Routing](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#step-8--update-your-app-s-routing)
    1. [Marking invited users as onboarded](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#marking-invited-users-as-onboarded)
    2. [Considerations](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#considerations)
10. [Conclusion](https://makerkit.dev/docs/next-supabase-turbo/recipes/onboarding-checkout#conclusion)