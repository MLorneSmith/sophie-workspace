[Skip to main content](https://lexical.dev/docs/concepts/commands#__docusaurus_skipToContent_fallback)
...
`editor.update` (and _never_ call `editor.read`) synchronously from within a command listener. It is safe to call
...
- [`createCommand(...)`](https://lexical.dev/docs/concepts/commands#createcommand)
- [`editor.dispatchCommand(...)`](https://lexical.dev/docs/concepts/commands#editordispatchcommand)
- [`editor.registerCommand(...)`](https://lexical.dev/docs/concepts/commands#editorregistercommand)
