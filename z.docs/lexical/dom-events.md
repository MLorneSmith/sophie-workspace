[Skip to main content](https://lexical.dev/docs/concepts/dom-events#__docusaurus_skipToContent_fallback)
...
- [1\. Event Delegation](https://lexical.dev/docs/concepts/dom-events#1-event-delegation)
- [2\. Directly Attach Handlers](https://lexical.dev/docs/concepts/dom-events#2-directly-attach-handlers)
- [3\. Use NodeEventPlugin](https://lexical.dev/docs/concepts/dom-events#3-use-nodeeventplugin)