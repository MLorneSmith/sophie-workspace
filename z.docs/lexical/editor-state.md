[Skip to main content](https://lexical.dev/docs/concepts/editor-state#__docusaurus_skipToContent_fallback)
...
_**Lexical**_ _**Lex** **ical**_ **_Lexical_**
...
![Nested structure of the HTML state](https://lexical.dev/img/docs/state-formatting-html.drawio.svg)Nested structure of the HTML state because of the formatting
...
- [Why is it necessary?](https://lexical.dev/docs/concepts/editor-state#why-is-it-necessary)
- [Understanding the Editor State](https://lexical.dev/docs/concepts/editor-state#understanding-the-editor-state)
- [Updating state](https://lexical.dev/docs/concepts/editor-state#updating-state)
- [State update listener](https://lexical.dev/docs/concepts/editor-state#state-update-listener)
- [When are Listeners, Transforms, and Commands called?](https://lexical.dev/docs/concepts/editor-state#when-are-listeners-transforms-and-commands-called)
- [Synchronous reconciliation with discrete updates](https://lexical.dev/docs/concepts/editor-state#synchronous-reconciliation-with-discrete-updates)
  - [Cloning state](https://lexical.dev/docs/concepts/editor-state#cloning-state)
