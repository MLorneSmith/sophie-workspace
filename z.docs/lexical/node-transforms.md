[Skip to main content](https://lexical.dev/docs/concepts/transforms#__docusaurus_skipToContent_fallback)
...
While it is possible to achieve the same or very similar result through an [update listener](https://lexical.dev/docs/concepts/listeners#registerupdatelistener) followed by an update, this is highly discouraged as it triggers an additional render (the most expensive lifecycle operation).
...
- [Syntax](https://lexical.dev/docs/concepts/transforms#syntax)
- [Lifecycle](https://lexical.dev/docs/concepts/transforms#lifecycle)
  - [Transform heuristic](https://lexical.dev/docs/concepts/transforms#transform-heuristic)
- [Preconditions](https://lexical.dev/docs/concepts/transforms#preconditions)
- [Transforms on parent nodes](https://lexical.dev/docs/concepts/transforms#transforms-on-parent-nodes)
- [registerLexicalTextEntity](https://lexical.dev/docs/concepts/transforms#registerlexicaltextentity)
- [Examples](https://lexical.dev/docs/concepts/transforms#examples)