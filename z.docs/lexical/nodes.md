[Skip to main content](https://lexical.dev/docs/concepts/nodes#__docusaurus_skipToContent_fallback)
...
- [Base Nodes](https://lexical.dev/docs/concepts/nodes#base-nodes)
  - [`RootNode`](https://lexical.dev/docs/concepts/nodes#rootnode)
  - [`LineBreakNode`](https://lexical.dev/docs/concepts/nodes#linebreaknode)
  - [`ElementNode`](https://lexical.dev/docs/concepts/nodes#elementnode)
  - [`TextNode`](https://lexical.dev/docs/concepts/nodes#textnode)
  - [`DecoratorNode`](https://lexical.dev/docs/concepts/nodes#decoratornode)
- [Node Properties](https://lexical.dev/docs/concepts/nodes#node-properties)
- [Creating custom nodes](https://lexical.dev/docs/concepts/nodes#creating-custom-nodes)
  - [Extending `ElementNode`](https://lexical.dev/docs/concepts/nodes#extending-elementnode)
  - [Extending `TextNode`](https://lexical.dev/docs/concepts/nodes#extending-textnode)
  - [Extending `DecoratorNode`](https://lexical.dev/docs/concepts/nodes#extending-decoratornode)
