[Skip to main content](https://lexical.dev/docs/concepts/traversals#__docusaurus_skipToContent_fallback)
...
```\
\
### Examples [​](https://lexical.dev/docs/concepts/traversals\#examples "Direct link to heading")\
\
...
```\
\
### Depth First Caret Traversals [​](https://lexical.dev/docs/concepts/traversals\#depth-first-caret-traversals "Direct link to heading")\
\
...
```\
\
### Examples [​](https://lexical.dev/docs/concepts/traversals\#examples-1 "Direct link to heading")\
\
Given the following document tree, here are some examples of using the\
...
```\
\
## Future Direction [​](https://lexical.dev/docs/concepts/traversals\#future-direction "Direct link to heading")\
\
...
\
## History [​](https://lexical.dev/docs/concepts/traversals\#history "Direct link to heading")\
\
...
the core.\
\
## Terminology [​](https://lexical.dev/docs/concepts/traversals\#terminology "Direct link to heading")\
\
### Caret [​](https://lexical.dev/docs/concepts/traversals\#caret "Direct link to heading")\
\
...
\
### Origin [​](https://lexical.dev/docs/concepts/traversals\#origin "Direct link to heading")\
\
...
\
### ChildCaret / SiblingCaret [​](https://lexical.dev/docs/concepts/traversals\#childcaret--siblingcaret "Direct link to heading")\
\
These were chosen because they match the existing methods on `ElementNode`\
and `LexicalNode` ( `getFirstChild`, `getNextSibling`, etc.)\
\
### Direction [​](https://lexical.dev/docs/concepts/traversals\#direction "Direct link to heading")\
\
...
and right-to-left.\
\
### Distance [​](https://lexical.dev/docs/concepts/traversals\#distance "Direct link to heading")\
\
...
non-negative.\
\
- [Concepts](https://lexical.dev/docs/concepts/traversals#concepts)\
  - [NodeCaret](https://lexical.dev/docs/concepts/traversals#nodecaret)\
  - [SiblingCaret](https://lexical.dev/docs/concepts/traversals#siblingcaret)\
  - [ChildCaret](https://lexical.dev/docs/concepts/traversals#childcaret)\
  - [PointCaret](https://lexical.dev/docs/concepts/traversals#pointcaret)\
  - [TextPointCaret](https://lexical.dev/docs/concepts/traversals#textpointcaret)\
  - [TextPointCaretSlice](https://lexical.dev/docs/concepts/traversals#textpointcaretslice)\
  - [CaretRange](https://lexical.dev/docs/concepts/traversals#caretrange)\
- [Traversal Strategies](https://lexical.dev/docs/concepts/traversals#traversal-strategies)\
  - [Adjacent Caret Traversals](https://lexical.dev/docs/concepts/traversals#adjacent-caret-traversals)\
  - [Examples](https://lexical.dev/docs/concepts/traversals#examples)\
  - [Depth First Caret Traversals](https://lexical.dev/docs/concepts/traversals#depth-first-caret-traversals)\
  - [Examples](https://lexical.dev/docs/concepts/traversals#examples-1)\
- [Future Direction](https://lexical.dev/docs/concepts/traversals#future-direction)\
- [History](https://lexical.dev/docs/concepts/traversals#history)\
- [Terminology](https://lexical.dev/docs/concepts/traversals#terminology)\
  - [Caret](https://lexical.dev/docs/concepts/traversals#caret)\
  - [Origin](https://lexical.dev/docs/concepts/traversals#origin)\
