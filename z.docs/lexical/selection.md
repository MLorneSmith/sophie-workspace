[Skip to main content](https://lexical.dev/docs/concepts/selection#__docusaurus_skipToContent_fallback)
...
- [Types of selection](https://lexical.dev/docs/concepts/selection#types-of-selection)
  - [`RangeSelection`](https://lexical.dev/docs/concepts/selection#rangeselection)
  - [`NodeSelection`](https://lexical.dev/docs/concepts/selection#nodeselection)
  - [`TableSelection`](https://lexical.dev/docs/concepts/selection#tableselection)
  - [`null`](https://lexical.dev/docs/concepts/selection#null)
- [Working with selection](https://lexical.dev/docs/concepts/selection#working-with-selection)
- [Focus](https://lexical.dev/docs/concepts/selection#focus)
