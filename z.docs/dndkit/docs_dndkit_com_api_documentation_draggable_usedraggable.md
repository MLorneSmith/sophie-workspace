![](https://docs.dndkit.com/~gitbook/image?url=https%3A%2F%2F3633755066-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-legacy-files%2Fo%2Fassets%252F-MMujhzqaYbBEEmDxnZO%252F-MPGCOtXOCWtvTWIPGD3%252F-MPGCsQge8_kUm7YTaap%252FDraggable.png%3Falt%3Dmedia%26token%3Df3f06703-0888-4441-910c-523906f3b77e&width=768&dpr=4&quality=100&sign=1f16314c&sv=2)

## [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#arguments)    Arguments
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#identifier)    Identifier
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#data)    Data
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#disabled)    Disabled
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#attributes)    Attributes
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#role)    Role
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#role-description)    Role description
...
## [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#properties)    Properties
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#active)    Active

#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#active-1)    `active`
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#isdragging)    `isDragging`
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#listeners)    Listeners
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#flexibility)    Flexibility
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#performance)    Performance
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#node)    Node
...
#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#node-1)    `node`

A [ref](https://reactjs.org/docs/refs-and-the-dom.html) to the current node that is passed to `setNodeRef`

### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#activator)    Activator
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#over)    Over

#### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#over-1)    `over`
...
### [Direct link to heading](https://docs.dndkit.com/api-documentation/draggable/usedraggable\#transform)    Transform
