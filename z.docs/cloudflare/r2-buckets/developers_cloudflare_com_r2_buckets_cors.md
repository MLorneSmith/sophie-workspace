[Skip to content](https://developers.cloudflare.com/r2/buckets/cors/#_top)
...
**[Set a bucket to public:](https://developers.cloudflare.com/r2/buckets/cors/#use-cors-with-a-public-bucket)** This option makes your bucket accessible on the Internet as read-only, which means anyone can request and load objects from your bucket in their browser or anywhere else. This option is ideal if your bucket contains images used in a public blog.

**[Presigned URLs:](https://developers.cloudflare.com/r2/buckets/cors/#use-cors-with-a-presigned-url)** Allows anyone with access to the unique URL to perform specific actions on your bucket.
...
Next, [add a CORS policy](https://developers.cloudflare.com/r2/buckets/cors/#add-cors-policies-from-the-dashboard) to your bucket to allow the file to be shared.
