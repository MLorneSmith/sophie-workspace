[Skip to content](https://developers.cloudflare.com/r2/buckets/object-lifecycles/#_top)
...
- Managing object lifecycles is a bucket-level action, and requires an API token with the [`Workers R2 Storage Write`](https://developers.cloudflare.com/r2/api/s3/tokens/#permission-groups) permission group.
