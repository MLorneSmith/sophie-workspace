[Skip to content](https://developers.cloudflare.com/r2/buckets/bucket-locks/#_top)
...
- An API token with [permissions](https://developers.cloudflare.com/r2/api/s3/tokens/#permissions) to edit R2 bucket configuration.
...
For more information on required parameters and examples of how to enable bucket lock, refer to the [API documentation](https://developers.cloudflare.com/api/resources/r2/subresources/buckets/subresources/locks/methods/update/). For information about getting started with the Cloudflare API, refer to [Make API calls](https://developers.cloudflare.com/fundamentals/api/how-to/make-api-calls/).
