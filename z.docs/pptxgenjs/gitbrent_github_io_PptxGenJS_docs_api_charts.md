[Skip to main content](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#docusaurus_skipToContent_fallback)

⭐️ If you like PptxGenJS, give it a star on [GitHub](https://github.com/gitbrent/PptxGenJS)! ⭐️

On this page

Charts of almost any type can be added to Slides, including combo and 3D charts. See [demos/modules/demo\_chart.mjs](https://github.com/gitbrent/PptxGenJS/blob/master/demos/modules/demo_chart.mjs) for the working code used to create the charts shown below.

![PptxGenJS Chart Samples](https://gitbrent.github.io/PptxGenJS/assets/images/demo-all-charts-c43a5317a5a4a1f288d896bef8cd2de5.png)

## Usage [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#usage "Direct link to heading")
...
### Core Chart Types [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#core-chart-types "Direct link to heading")
...
### Combo Charts [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#combo-charts "Direct link to heading")
...
### Usage Notes [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#usage-notes "Direct link to heading")
...
## Properties [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#properties "Direct link to heading")

### Position/Size Props ( [PositionProps](https://gitbrent.github.io/PptxGenJS/docs/types/\#position-props-positionprops)) [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#positionsize-props-positionprops "Direct link to heading")
...
### General ( `IChartOpts`), Data Table ( `IChartPropsDataTable`), Legend ( `IChartPropsLegend`), Title ( `IChartPropsTitle`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#general-ichartopts-data-table-ichartpropsdatatable-legend-ichartpropslegend-title-ichartpropstitle "Direct link to heading")
...
### Cat Axis ( `IChartPropsAxisCat`) and Val Axis ( `IChartPropsAxisVal`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#cat-axis-ichartpropsaxiscat-and-val-axis-ichartpropsaxisval "Direct link to heading")
...
### Bar ( `IChartPropsChartBar`), Data Label ( `IChartPropsDataLabel`), Line ( `IChartPropsChartLine`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#bar-ichartpropschartbar-data-label-ichartpropsdatalabel-line-ichartpropschartline "Direct link to heading")
...
| `shadow` | ShadowProps |  | data element shadow options | `none` or [`ShadowProps`](https://gitbrent.github.io/PptxGenJS/docs/types/#shadow-props-shadowprops) |

### 3D Bar Chart ( `IChartPropsChartBar`), Series Axis ( `IChartPropsDataTable`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#3d-bar-chart-ichartpropschartbar-series-axis-ichartpropsdatatable "Direct link to heading")
...
### Element Shadows [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#element-shadows "Direct link to heading")
...
### Combo Chart Options [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#combo-chart-options "Direct link to heading")
...
## Samples [​](https://gitbrent.github.io/PptxGenJS/docs/api-charts/\#samples "Direct link to heading")

Sample code: [demos/modules/demo\_chart.mjs](https://github.com/gitbrent/PptxGenJS/blob/master/demos/modules/demo_chart.mjs)

- [Usage](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#usage)
  - [Core Chart Types](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#core-chart-types)
  - [Combo Charts](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#combo-charts)
  - [Usage Notes](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#usage-notes)
- [Properties](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#properties)
  - [Position/Size Props (PositionProps)](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#positionsize-props-positionprops)
  - [General ( `IChartOpts`), Data Table ( `IChartPropsDataTable`), Legend ( `IChartPropsLegend`), Title ( `IChartPropsTitle`)](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#general-ichartopts-data-table-ichartpropsdatatable-legend-ichartpropslegend-title-ichartpropstitle)
  - [Cat Axis ( `IChartPropsAxisCat`) and Val Axis ( `IChartPropsAxisVal`)](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#cat-axis-ichartpropsaxiscat-and-val-axis-ichartpropsaxisval)
  - [Bar ( `IChartPropsChartBar`), Data Label ( `IChartPropsDataLabel`), Line ( `IChartPropsChartLine`)](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#bar-ichartpropschartbar-data-label-ichartpropsdatalabel-line-ichartpropschartline)
  - [3D Bar Chart ( `IChartPropsChartBar`), Series Axis ( `IChartPropsDataTable`)](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#3d-bar-chart-ichartpropschartbar-series-axis-ichartpropsdatatable)
  - [Element Shadows](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#element-shadows)
  - [Combo Chart Options](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#combo-chart-options)
- [Samples](https://gitbrent.github.io/PptxGenJS/docs/api-charts/#samples)