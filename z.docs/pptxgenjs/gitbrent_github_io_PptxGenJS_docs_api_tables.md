[Skip to main content](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#docusaurus_skipToContent_fallback)
...
## Usage [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#usage "Direct link to heading")
...
### Usage Notes [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#usage-notes "Direct link to heading")
...
### Cell Formatting [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#cell-formatting "Direct link to heading")
...
- Available formatting options are here: [Text Props](https://gitbrent.github.io/PptxGenJS/docs/api-text/#base-properties-textpropsoptions)

### Row Height [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#row-height "Direct link to heading")
...
## Properties [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#properties "Direct link to heading")

### Position/Size Props ( [PositionProps](https://gitbrent.github.io/PptxGenJS/docs/types/\#position-props)) [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#positionsize-props-positionprops "Direct link to heading")
...
### Table Layout Options ( `ITableOptions`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-layout-options-itableoptions "Direct link to heading")
...
### Table Formatting Props ( `ITableOptions`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-formatting-props-itableoptions "Direct link to heading")
...
| `color` | string |  |  | text color | hex color code or [scheme color constant](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#scheme-colors). Ex: `{color:'0088CC'}` |
| `colspan` | integer |  |  | column span | 2-n. Ex: `{colspan:2}` (Note: be sure to include a table `w` value) |
| `fill` | string |  |  | fill/bkgd color | hex color code or [scheme color constant](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#scheme-colors). Ex: `{color:'0088CC'}` |
...
### Table Border Options ( `IBorderOptions`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-border-options-iborderoptions "Direct link to heading")

| Option | Type | Default | Description | Possible Values |
| :-- | :-- | :-- | :-- | :-- |
| `type` | string | `solid` | border type | `none` or `solid` or `dash` |
| `pt` | string | `1` | border thickness | any positive number |
| `color` | string | `black` | cell border | hex color code or [scheme color constant](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#scheme-colors). Ex: `{color:'0088CC'}` |

## Table Auto-Paging [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-auto-paging "Direct link to heading")

Auto-paging will create new slides as table rows overflow, doing the magical work for you.

### Table Auto-Paging Options ( `ITableOptions`) [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-auto-paging-options-itableoptions "Direct link to heading")
...
### Auto-Paging Property Notes [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#auto-paging-property-notes "Direct link to heading")
...
### Auto-Paging Usage Notes [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#auto-paging-usage-notes "Direct link to heading")
...
## Examples [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#examples "Direct link to heading")

### Table Cell Formatting [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#table-cell-formatting "Direct link to heading")
...
![Table Cell Formatting](https://gitbrent.github.io/PptxGenJS/assets/images/ex-table-cell-format-2a4c51f4ad042e23f06fcdc0c197ee06.png)

## Samples [​](https://gitbrent.github.io/PptxGenJS/docs/api-tables/\#samples "Direct link to heading")

Sample code: [demos/modules/demo\_table.mjs](https://github.com/gitbrent/PptxGenJS/blob/master/demos/modules/demo_table.mjs)

- [Usage](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#usage)
  - [Usage Notes](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#usage-notes)
  - [Cell Formatting](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#cell-formatting)
  - [Row Height](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#row-height)
- [Properties](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#properties)
  - [Position/Size Props (PositionProps)](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#positionsize-props-positionprops)
  - [Table Layout Options ( `ITableOptions`)](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-layout-options-itableoptions)
  - [Table Formatting Props ( `ITableOptions`)](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-formatting-props-itableoptions)
  - [Table Border Options ( `IBorderOptions`)](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-border-options-iborderoptions)
- [Table Auto-Paging](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-auto-paging)
  - [Table Auto-Paging Options ( `ITableOptions`)](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-auto-paging-options-itableoptions)
  - [Auto-Paging Property Notes](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#auto-paging-property-notes)
  - [Auto-Paging Usage Notes](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#auto-paging-usage-notes)
- [Examples](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#examples)
  - [Table Cell Formatting](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#table-cell-formatting)
- [Samples](https://gitbrent.github.io/PptxGenJS/docs/api-tables/#samples)