...
<test2@slideheroes.com> user. It marks all lessons as complete except for lessons 702, 801, and 802.
...
This script is useful for testing the certificate generation functionality, as it will trigger
the certificate generation process when the course is marked as complete.
